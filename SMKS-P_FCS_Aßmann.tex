...
\begin{document}
	...
	\begin{equation}
	\begin{split}
		G(t_c)&=1+\frac{1}{N_{eff}}[x_1(\frac{1}{1+\frac{t_c}{t_{D1}}})(\frac{1}{1+(\frac{\omega_0}{z_0})^2\frac{t_c}{t_{D1}}})^{\frac{1}{2}}+(1-x_1)(\frac{1}{1+\frac{t_c}{t_{D2}}})(\frac{1}{1+(\frac{\omega_0}{z_0})^2\frac{t_c}{t_{D2}}})^{\frac{1}{2}}]\\
		&\cdot[1+K_Te^{-\frac{t_c}{t_T}}+K_Re^{-k_Rt_c}]
	\end{split}
	\end{equation}
